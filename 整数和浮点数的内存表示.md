...
调用了 Number.prototype.toFixed，返回 255.00，Number.prototype.toFixed 调用了 V8 的 [BUILTIN(NumberPrototypeToFixed)](https://chromium.googlesource.com/v8/v8.git/+/refs/heads/8.4-lkgr/src/builtins/builtins-number.cc)。
