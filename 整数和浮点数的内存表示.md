...
基于 node 版本 14.13.0，V8 版本 8.4.371。本文介绍的是 JavaScript 的整数和浮点数在内存中的表示，以 [Number.prototype.toFixed()](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number/toFixed) 的源码展开。
